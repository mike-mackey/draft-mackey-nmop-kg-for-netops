...
- The basic concepts of the Digital Map are mentioned in [draft-havel-nmop-digital-map-concept](https://datatracker.ietf.org/doc/draft-ietf-nmop-simap-concept/)  
...
YANG's extension mechanisms (augment, deviation, import) are formal and
...
without modifying the underlying YANG modules or maintaining out-of-band metadata.

While YANG defines rich constraints within a single module or module set (must,
...
YANG does not provide a built-in mechanism for inferring new knowledge from 
...
model describes what data exists, but not how to reason over it.

Finally, YANG is one of many modeling languages in the operational ecosystem. 
...
As this document is informational and covers the Knoweldge Graph concepts and
